...
#define CHEM_DISPENSER_ENERGY_COST	0.25	//How many energy points do we use per unit of chemical?
...
/obj/machinery/chem_dispenser
	...
	"sodium","aluminum","silicon","phosphorus","sulfur","chlorine","potassium","iron", "aceticacid",
