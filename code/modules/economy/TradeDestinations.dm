...
/datum/trade_destination
	...
	var/can_shuttle_here = 0		//one day crew from the prospector will be able to travel to this destination
...
/datum/trade_destination/icarus
	name = "NDV Icarus"
	description = "Corvette assigned to patrol NSS Prospector local space."
	distance = 0.1
	willing_to_buy = list()
	willing_to_sell = list()
