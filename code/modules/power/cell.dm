 ...
 * */
	...
	log_admin("LOG: Rigged power cell explosion, last affect_touched by [fingerprintslast]")
	message_admins("LOG: Rigged power cell explosion, last affect_touched by [fingerprintslast]")
