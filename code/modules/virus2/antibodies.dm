...
datum/reagent/antibodies
	...
	affect_touch(var/mob/living/carbon/M, var/alien, var/removed, var/method, var/affect_blood)
...
/proc/antigens2string(var/antigens)
	var/code = ""
	for(var/V in ALL_ANTIGENS) if(text2num(V) & antigens) code += ALL_ANTIGENS[V]
	return code