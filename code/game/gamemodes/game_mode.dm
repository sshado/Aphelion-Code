...
/datum/game_mode
	...
	var/antag_scaling_coeff = 4              // Coefficient for scaling max antagonists to player count.
	...
	var/list/datum/uplink_item/uplink_items = list(
		...
		"Implants" = list(
			...
			new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/imp_amnesia, 2, "Amnesia Implant", "AI"),
			new/datum/uplink_item(/obj/item/weapon/storage/box/syndie_kit/imp_enslavement, 4, "Enslavement Implant", "EI")
			),
		"Medical" = list(
