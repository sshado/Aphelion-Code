...
```
If you see any errors or warnings, something has gone wrong - possibly a corrupt download or the files extracted wrong, or a code issue on the main repo.  Ask on Gitter.
...
For a basic setup, simply copy every file from config/example to config, and edit them directly.
